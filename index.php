  ...
  <body>
    ...
    <div class="container">
      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">RBNB NEWS PORTAL</a>
          </div>
     ...
     <div class="card" style="width:100%; height:350px;" >
      <img class="card-img-top" src="images\rbnb3.jpeg" alt="Card image" height="350" >
       ...
       ?>
        ...
        <aside class="col-md-4 blog-sidebar">
          <div class="p-3 mb-3 bg-light rounded">
            ...
            <p class="mb-0">RBNB NEWS PORTAL <em>Created By Sahil And Mayuresh <br> Contact Info:: Email Us <br> rbnbnewsportal@gmail.com</p>
          </div>
    ...
    <footer class="blog-footer">
      <p>Follow my social handle   <a href="https://twitter.com/mayuresh3036 <br> https://twitter.com/sahil5757">@mayuresh @sahil</a>.</p>
      <p>
